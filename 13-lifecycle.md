...
### Sprawdź również:
- [System zdarzeń Doctrine](https://symfony.com/doc/current/doctrine/events.html) (callbacki cyklu życia i nasłuchiwacze, entity listeners oraz subskrybenci cyklu życia);
